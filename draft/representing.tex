...
nothing otherwise. In the end, each element that was added as the same
probability of being in the collection.

Unfortunately, iterating over the collection to produce new instances
of types bias the generation toward small instances. To get an idea of
...
We have experimented with the three containers structures described
...
empirically.
%
However, it is likelly that other kind of containers, or other tunings
